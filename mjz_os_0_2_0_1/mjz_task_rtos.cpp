...
namespace mjz_ard {
  ...
  mjz_task_class::~mjz_task_class() {
    ...
    number_of_apps--; } // destroy  TaskHandle_t &  WRState
...
void run_code() {
  ...
  ticker__CLI_loop.attach_ms( 30, Tiker_task_suspender, ( void * )&xHandle_CLI_loop );
  ticker__CLI_loop.attach_ms( 11, Tiker_task_Resumer, ( void * )&xHandle_CLI_loop ); }
...
void mjz_create_ble_task() {
  xHandle_BLE_loop = xTaskCreateStaticPinnedToCore(
                       ...
                       0 );                       // Specify the task's core affinity
  ticker__BLE_loop.attach_ms( 30, Tiker_task_suspender, ( void * )&xHandle_BLE_loop );
  ticker__BLE_loop.attach_ms( 11, Tiker_task_Resumer, ( void * )&xHandle_BLE_loop ); }
